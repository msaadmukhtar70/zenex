...
const service_data: DataType[] = [
  {
    ...
    des: "We build fast, secure, and scalable websites, web apps, and SaaS platforms tailored to your business goals. From MVPs to full-scale systems, our development team brings your ideas to life with precision and performance.",
    slug: "web-app-development"
  },
  {
    id: 2,
    title: "Product & UI/UX Design",
    des: "Design that delivers. We craft user-centered interfaces that are not just beautiful, but built to convert. From wireframes to design systems, every pixel has purpose.",
    slug: "product-ui-ux-design"
  },
  {
    id: 3,
    title: "Branding & Identity",
    des: "We go beyond logos to build lasting brands. Whether you're starting from scratch or rebranding, we create visual identities and messaging that connect with your audience and tell your story clearly.",
    slug: "branding-identity"
  },
  {
    id: 4,
    title: "AI & Automation Solutions",
    des: "Unlock smarter workflows and better customer experiences with AI. From chatbots to automation and predictive tools, we help you streamline operations and stay ahead of the curve.",
    slug: "ai-automation-solutions"
  },
  {
    id: 5,
    title: "Digital Marketing & Growth",
    des: "We help you get found, seen, and chosen. Our digital marketing services combine SEO, paid ads, content, and conversion optimization to drive real growth and measurable results.",
    slug: "digital-marketing-growth"
  },
  {
    id: 6,
    title: "Strategy & Consulting",
    des: "Need a plan? We help startups and scaling teams build the right roadmap—from product launches to marketing funnels. Think of us as your strategic tech partner, not just another agency.",
