...
const testimonial_data: DataType[] = [
  ...
  },
  {
    ...
    des: "“Their branding work was a game-changer. Our new identity feels fresh, professional, and finally speaks to the right audience.”"
  },
  {
    img: avatar_img,
    name: "Ravi Shah",
  ...
  },
  {
    ...
    des: "“The team understood our product from day one and guided us through a full UX overhaul. The new design cut our bounce rate in half.”"
  },
  {
    img: avatar_img,
    name: "Luis Herrera",
    location: "From Spain",
    des: "“From paid ads to SEO, their marketing team helped us grow our traffic and leads. They’re not just creatives — they understand business goals too.”"
  },
  {
    img: avatar_img,
    name: "Jasmine Lee",
    location: "From Singapore",
    des: "“What stood out was their consulting. We came in with a rough idea and left with a clear MVP strategy, timelines, and a product roadmap. Invaluable.”"
  },
  {
    img: avatar_img,
    name: "Connor Walsh",
